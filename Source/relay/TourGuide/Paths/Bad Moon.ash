...
static
{
    ...
    void initialiseStaticBadMoonAdventures()
    {
        ...
        __static_bad_moon_adventures.listAppend(BadMoonAdventureMake(8, $location[Frat House (frat disguise)], "STAT3", "+50% muscle, -50% moxie", "", false));
        __static_bad_moon_adventures.listAppend(BadMoonAdventureMake(9, $location[Hippy Camp], "STAT3", "+50% myst, -50% moxie", "", false));
        __static_bad_moon_adventures.listAppend(BadMoonAdventureMake(10, $location[Hippy Camp (hippy disguise)], "STAT3", "+50% myst, -50% muscle", "", false));
